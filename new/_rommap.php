        ...
        foreach ($this->names as $addr => $name) {
            ...
            if ($addr !== $expected) {
                ...
                if (!$align) {
                    ...
                    if ($previous != null) {
                        if (in_array($previous->type, ['TilesetPalettes', 'Palette', 'Pal'])) {
                            fwrite($out, " @ pal");
                        }else if (in_array($previous->type, ['TilesetTiles', 'Tiles', 'Gfx'])) {
                            fwrite($out, " @ gfx");
                        }else if (in_array($previous->type, ['Tilemap', 'Map'])) {
                            fwrite($out, " @ map");
                        }else if (in_array($previous->type, ['MapBlockdata', 'Border', 'Metatiles', 'MetatileAttributes', 'MapBlockdata'])) {
                            fwrite($out, " @ binary");
                        } else {
                            fwrite($out, " @ FINDME");
                        }
